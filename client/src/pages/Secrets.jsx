        ...
        {!selectedProject ? (
          ...
          <div className="hero-glass-card py-24 text-center border-dashed border-white/10">
            ...
            <p className="text-white/40 max-w-sm mx-auto mb-8 text-sm">
               This environment is currently devoid of runtime configurations. {isAdmin ? 'Initialize your first industrial-grade secret.' : 'Awaiting administrative provisioning.'}
            </p>
            {isAdmin && <button onClick={() => setShowModal(true)} className="btn-purple px-10 py-4 font-bold tracking-tight">Initialize Secret</button>}
          </div>
        ) : (
